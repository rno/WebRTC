...
The latest release is available on [Maven Central](https://search.maven.org/artifact/com.dafruits/webrtc/113.0.0/aar)
...
```kotlin
implementation(files("libs/libwebrtc-113.0.0.aar"))
```
